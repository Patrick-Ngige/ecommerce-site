...
<body>
    ...
    ================== -->
        ...
        <style>
            ...
            .sub-total:not(:first-child) {
                border-top: 1.5px solid hsl(0, 0%, 93%);
            }
        ...
        <div class="checkout-container" style="margin-top: 20px;">
            ...
            ====================== -->
                ...
                <div class="checkout-form">
                    ...
                    <h2 class="title" style="width: 90%; margin-left: 5%;margin-bottom: 0;">DELIVERY INFORMATION</h2>
        ...
        <div class="total-amount">
            <h2 class="title" style="width: 78%; margin-top: 50px;">CART TOTALS</h2>
            ...
            <div class="amount-breakdown">
                ...
                <div class="sub-total sum">
                    <div class="sub-text">
                        <p class="total">Total</p>
                    </div>

                    <div class="sub-amount">
                        <p class="total-sum">Ksh. 16,900.00</p>
                    </div>

                </div>

                <div class="payment-method">
                    <h2 class="title" style="width: 100%; margin-top: 50px;">PAYMENT METHOD</h2>
            ...
            <!-- <h2 class="title" style="width: 78%; margin-top: 50px;">CART TOTALS</h2> -->
                    ...
                    <div class="payment-options">
                        ...
                        <label class="image-checkbox">
                            ...
                            <img src="./assets/images/payment methods/m-pesa.jpeg" alt="M-Pesa">
                        </label>
                        <label class="image-checkbox">
                            <input type="checkbox" name="image2">
                            <img src="./assets/images/payment methods/paypal.jpeg" alt="Paypal">
                        </label>
                        <label class="image-checkbox">
                            <input type="checkbox" name="image3">
                            <img src="./assets/images/payment methods/mastercad.jpeg" alt="Mastercard">
                        </label>
                        <label class="image-checkbox">
                            <input type="checkbox" name="image3">
                            <img src="./assets/images/payment methods/visa.jpeg" alt="Visa">
                        </label>
                        <label class="image-checkbox">
                            <input type="checkbox" name="image3">
                            <img src="./assets/images/payment methods/airtel-money.jpeg" alt="Airtel Money">
                        </label>
                ...
                <div class="checkout-btn">
                    <a href="orders.html"><button>Place Order </button></a>
                </div>
