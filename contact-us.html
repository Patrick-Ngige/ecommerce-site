...
<body>
        ...
        <nav class="desktop-navigation-menu">
            ...
            <div class="container">
                ...
                <ul class="desktop-menu-category-list">
                    ...
                    <li class="menu-category">
                        <a href="http://127.0.0.1:5500/about-us.html" class="menu-title">About Us</a>
                    </li>
    ...
    ================== -->
        ...
        <div class="product-container" style="margin-top: 10px;">
            <h2 class="title" style="width: 90%; margin-left: 5%;">CONTACT US</h2>
            <div class="container">
                        ...
                        <div class="showcase-container" style="border: none;">
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    <img src="./assets/images/contact-support-help.jpg"
                                        alt="shampoo, conditioner & facewash packs" class="showcase-img">
                                </div>

                                <div class="showcase-content">

                                    <h3 class="showcase-title" style="text-transform: capitalize;">Our Store</h3>
                                        <br>
                                    <p class="showcase-desc">
                                        Room D35 Dubai Mecharnt, <br>
                                        Ronald Ngala Avenue, Nairobi, Kenya
                                    </p>
                                    <br>

                                    <p class="showcase-desc">
                                        Tel: +254 700 112 233 <br>
                                        Email: shopify@yahoo.com
                                    </p>

                                    <br>

                                    <h3 class="showcase-title" style="text-transform: capitalize;">Our Team</h3>
                                    ...
                                    <h3 class="showcase-title" style="text-transform: capitalize;">Our Socials</h3> <br>
